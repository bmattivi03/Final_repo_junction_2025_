...
var require_leaflet_maplibre_gl = __commonJS({
  "node_modules/@maplibre/maplibre-gl-leaflet/leaflet-maplibre-gl.js"(exports, module) {
    (function(root, factory) {
      if (typeof define === "function" && define.amd) {
        define(["leaflet", "maplibre-gl"], factory);
      } else if (typeof exports === "object") {
        module.exports = factory(require_leaflet_src(), require_maplibre_gl());
      } else {
        root.returnExports = factory(root.L, root.maplibregl);
      }
    })(typeof globalThis !== "undefined" ? globalThis : exports || self, function(L, maplibregl) {
      L.MaplibreGL = L.Layer.extend({
        ...
        getAttribution: function() {
          ...
          if (map && this.options.attributionControl !== false) {
            ...
            if (style && style.sources) {
              return Object.keys(style.sources).map(function(sourceId) {
        ...
        _transformGL: function(gl) {
          var center = this._map.getCenter();
          var tr = gl._getTransformForUpdate();
          if (tr.setCenter) {
...
export default require_leaflet_maplibre_gl();
//# sourceMappingURL=@maplibre_maplibre-gl-leaflet.js.map
