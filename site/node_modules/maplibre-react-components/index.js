...
const RMapContext = createContext(null);
const RMapContextProvider = ({ children }) => {
	...
	return /* @__PURE__ */ jsx(RMapContext.Provider, {
...
const CurrentMapIdContext = createContext(null);

//#endregion
//#region src/components/RMap/RMap.tsx
const childContainerStyle = { height: "100%" };
const RMap = forwardRef(function RMap$1({ children, style, id: propsId, className, onMounted, mapStyle, styleDiffing, styleTransformStyle, padding,...mapProps }, ref) {
	...
	const localMapManagersRef = useRef(null);
	...
	*/
	...
	return /* @__PURE__ */ jsx("div", {
		...
		id,
		style: completeStyle,
		children: mapManagers.get(id) && /* @__PURE__ */ jsx(CurrentMapIdContext.Provider, {
			value: id,
			children: externalMapManagersRef ? /* @__PURE__ */ jsx("div", {
				className: "maplibregl-children",
				style: childContainerStyle,
				children
			}) : /* @__PURE__ */ jsx(RMapContext.Provider, {
...
const RMarker = memo(forwardRef(function RMarker$1(props, ref) {
...
const RLayer = memo(forwardRef(function RLayer$1(props, ref) {
...
const RSource = memo(forwardRef(function RSource$1(props, ref) {
...
var GradientMarker = class extends maplibregl.Marker {
	_interactive;
	_shape;
	_icon;
...
const RGradientMarker = memo(forwardRef(function RGradientMarker$1(props, ref) {
...
function useRControl({ position, className = "maplibregl-ctrl maplibregl-ctrl-group" }) {
	const map = useMap();
	const containerRef = useRef(null);
	const prevOptionsRef = useRef({ className });
...
const MrcLogoControl = memo(function MrcLogoControl$1({ position = "bottom-left" }) {
	const { container } = useRControl({
		position,
		className: "maplibregl-ctrl maplibregl-ctrl-mrc-logo"
	});
	return createPortal(/* @__PURE__ */ jsx("a", {
		target: "_blank",
		rel: "noopener nofollow",
		href: "https://maplibre-react-components.pentatrion.com",
		"aria-label": "MapLibre React components logo",
		children: /* @__PURE__ */ jsx(MapLibreReactLogo, { height: 30 })
	}), container);
});
...
const RAttributionControl = memo(forwardRef(function RAttributionControl$1({ position = "bottom-right",...controlOptions }, ref) {
...
const RFullscreenControl = memo(forwardRef(function RFullscreenControl$1({ position = "top-right",...controlOptions }, ref) {
	const control = useControl({
		position,
...
const RGeolocateControl = memo(forwardRef(function RGeolocateControl$1({ position = "top-right",...controlOptions }, ref) {
	const control = useControl({
		position,
...
const RGlobeControl = memo(forwardRef(function RGlobeControl$1({ position = "top-right" }, ref) {
	const control = useControl({
		position,
...
const RLogoControl = memo(forwardRef(function RLogoControl$1({ position = "bottom-left",...controlOptions }, ref) {
	const control = useControl({
		position,
...
const RNavigationControl = memo(forwardRef(function RNavigationControl$1({ position = "top-right",...controlOptions }, ref) {
	const control = useControl({
		position,
...
const RScaleControl = memo(forwardRef(function RScaleControl$1({ position = "bottom-left",...controlOptions }, ref) {
	const control = useControl({
		position,
...
const RTerrainControl = memo(forwardRef(function RTerrainControl$1({ position = "top-right",...controlOptions }, ref) {
	const control = useControl({
		position,
...
const useMapAndCanvasRefs = () => {
	...
	const setMapAndCanvasRef = useCallback((map) => {
		mapRef.current = map;
...
//#endregion
export { ContextMenuEventAdapter, CurrentMapIdContext, GradientMarker, MapLibreReactLogo, MapManager, MrcLogoControl, RAttributionControl, RFullscreenControl, RGeolocateControl, RGlobeControl, RGradientMarker, RLayer, RLogoControl, RMap, RMapContext, RMapContextProvider, RMarker, RNavigationControl, RPopup, RScaleControl, RSource, RTerrain, RTerrainControl, areCoordsClose, areLngLatClose, arePointsEqual, deepEqual, emptyStyle, filterMapProps, gradientMarkerPopupOffset, lngLatClassToObj, markerPopupOffset, prepareEventDep, transformPropsToOptions, uniqueId, updateClassNames, updateListeners, useCanvasRef, useControl, useMap, useMapAndCanvasRefs, useMapManager, useRControl };