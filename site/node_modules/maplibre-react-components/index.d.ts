...
declare const RLayer: react26.NamedExoticComponent<RLayerProps & react26.RefAttributes<unknown>>;
//#endregion
//#region src/components/RSource/RSource.d.ts
type RSourceProps = SourceSpecification & {
  readonly id: string;
};
declare const RSource: react28.NamedExoticComponent<RSourceProps & react28.RefAttributes<Source | null>>;
//#endregion
...
declare const RMap: react36.ForwardRefExoticComponent<MapReactiveOptions & MapHandlerOptions & MapInitialOptions & MapCallbacks & ManagerOptions & RMapComponentProps & react36.RefAttributes<Map | null>>;
//#endregion
...
declare const RMarker: react22.NamedExoticComponent<MarkerInitialOptions & MarkerReactiveOptions & MarkerCallbacks & {
  longitude: number;
  latitude: number;
  children?: ReactNode;
} & react22.RefAttributes<Marker>>;
//#endregion
...
declare const RGradientMarker: react24.NamedExoticComponent<GradientMarkerInitialOptions & GradientMarkerReactiveOptions & GradientMarkerCallbacks & {
  longitude: number;
  latitude: number;
} & react24.RefAttributes<GradientMarker>>;
//#endregion
...
declare const RMapContext: react17.Context<MutableRefObject<MapManagers> | null>;
interface RMapContextProviderProps {
  children: ReactNode;
}
declare const RMapContextProvider: ({
  children
}: RMapContextProviderProps) => react_jsx_runtime18.JSX.Element;
//#endregion
//#region src/contexts/CurrentMapIdContext.d.ts
declare const CurrentMapIdContext: react4.Context<string | null>;
//#endregion
...
declare const RAttributionControl: react0.NamedExoticComponent<AttributionControlOptions & {
  position?: ControlPosition;
} & react0.RefAttributes<IControl>>;
//#endregion
//#region src/controls/RFullscreenControl.d.ts
declare const RFullscreenControl: react5.NamedExoticComponent<FullscreenControlOptions & {
  position?: ControlPosition;
} & react5.RefAttributes<IControl>>;
//#endregion
//#region src/controls/RGeolocateControl.d.ts
declare const RGeolocateControl: react15.NamedExoticComponent<GeolocateControlOptions & {
  position?: ControlPosition;
} & react15.RefAttributes<IControl>>;
//#endregion
//#region src/controls/RGlobeControl.d.ts
type RGlobeControlProps = {
  position?: ControlPosition;
};
declare const RGlobeControl: react19.NamedExoticComponent<RGlobeControlProps & react19.RefAttributes<IControl>>;
//#endregion
//#region src/controls/RLogoControl.d.ts
declare const RLogoControl: react13.NamedExoticComponent<LogoControlOptions & {
  position?: ControlPosition;
} & react13.RefAttributes<IControl>>;
//#endregion
//#region src/controls/RNavigationControl.d.ts
declare const RNavigationControl: react7.NamedExoticComponent<NavigationControlOptions & {
  position?: ControlPosition;
} & react7.RefAttributes<IControl>>;
//#endregion
//#region src/controls/RScaleControl.d.ts
declare const RScaleControl: react11.NamedExoticComponent<ScaleControlOptions & {
  position?: ControlPosition;
} & react11.RefAttributes<IControl>>;
//#endregion
//#region src/controls/RTerrainControl.d.ts
declare const RTerrainControl: react9.NamedExoticComponent<TerrainSpecification & {
  position?: ControlPosition;
} & react9.RefAttributes<IControl>>;
//#endregion
...
declare const useCanvasRef: () => react21.RefObject<HTMLElement>;
//#endregion
